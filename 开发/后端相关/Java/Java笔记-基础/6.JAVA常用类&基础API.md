...
<center><font size=7><b>JAVA常用类&基础API</center></font></center>
...
JDK7开始，就移到堆空间，直到目前JDK17版本。



#### 举例内存结构分配

<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230421964.png" alt="img" style="zoom: 80%;" />

<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422124.png" alt="image-20220405152839525" style="zoom: 50%;" />

<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422370.png" alt="img" style="zoom:50%;" />

<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422805.png" alt="img" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422522.jpg" alt="img" style="zoom:50%;" />
...
![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422516.jpg)
...
>	toString过程"ab"字符串不会在常量池中也创建，最后StringBuilder的toString() 的调用，底层new String(value, 0, count) 并不会在字符串常量池中去创建"ab"对象。两个new String相加会被优化为StringBuilder
>
>4、最难的是再调用intern()方法，比如：
...
```java
	public void test01(){
		String str = "12345321234";
		System.out.println("是否包含532：" + str.contains("532"));
		System.out.println("532出现的第一次下标：" + str.indexOf("532"));
		System.out.println("123出现的最后一次下标：" + str.lastIndexOf("123"));
	}
```
...
#### 相关类之可变字符序列：StringBuffer、StringBuilder
...
<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422050.png" alt="img" style="zoom:80%;" />



##### 继承结构

![image-20220405174233055](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422235.png)

<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422526.png" alt="image-20220228153030902" style="zoom:67%;" />

<img src="https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422917.png" alt="img" style="zoom:67%;" />
...
- StringBuilder 和 StringBuffer 非常类似，均代表可变的字符序列，而且提供相关功能的方法也一样。
  - `String`:**不可变**的字符序列； 底层使用char[]数组存储(JDK8.0中)
  - `StringBuffer`:**可变**的字符序列；**线程安全**（方法有synchronized修饰），效率低；底层使用char[]数组存储 (JDK8.0中)
  - `StringBuilder`:**可变**的字符序列； jdk1.5引入，**线程不安全的**，效率高；底层使用char[]数组存储(JDK8.0中)
...
>
>   ![image-20220405223542750](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422518.png)
...
public class Test {
    public static void test1(){
        Date d = new Date();
        System.out.println(d);// Fri Apr 19 17:08:39 CST 2024
    }

    public static void test2(){
        long time = System.currentTimeMillis();
        System.out.println(time);//1713517719245
    ...
    public static void test4(){
        ...
        System.out.println(d1); //Thu Jun 06 15:44:07 CST 2019
...
![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422832.png)
...
- 获取Calendar实例的方法
  ...
  - | 方法                                     | 作用                                     |
    ...
    | getInstance(TimeZone one,Locale aLocale) | 使用指定时区和语言环境获得一个日历。     |

  - 调用它的子类GregorianCalendar（公历）的构造器。
    ![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422373.png)
...
Java 8中引入的 `java.time API` 纠正了过去的缺陷，将来很长一段时间内它都会为我们服务。
...
public class Test {
    public static void test1(){
        ...
        System.out.println(now1);		//2024-04-19
        System.out.println(now2);		//22:29:55.042814400
        System.out.println(now3);		//2024-04-19T22:29:55.042814400
    }
...
![image-20220406000442908](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230422292.png)
...
- 成员变量 Scanner scan = new Scanner([System.in](http://system.in/));
