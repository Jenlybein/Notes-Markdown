...
<center><font size=7><b>JAVA网络编程</center></font></center>
...
![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430986.jpg)

**B/S架构** ：全称为Browser/Server结构，是指浏览器和服务器结构。常见浏览器有IE、谷歌、火狐等。

![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430420.jpg)
...
- `IPv4`：是一个32位的二进制数，通常被分为4个字节，表示成`a.b.c.d` 的形式，以点分`十进制`表示，例如`192.168.65.100` 。其中a、b、c、d都是0~255之间的十进制整数。
  ...
  - ![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230429329.png)
  ...
  - IP地址 = 网络地址 +主机地址
    ...
    ![20220518_101503](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230431861.jpg)
...
![image-20220415003729013](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230429064.png)

详细理解：

![image-20220131125934581](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230429566.png)
...
5. 如果本地DNS服务器本地区域文件与缓存解析都失效，则根据本地DNS服务器的设置（是否设置转发器）进行查询，如果未用转发模式，本地DNS就把请求发至13台根DNS，根DNS服务器收到请求后会判断这个域名(.com)是谁来授权管理，并会返回一个负责该顶级域名服务器的一个IP。本地DNS服务器收到IP信息后，将会联系负责.com域的这台服务器。这台负责.com域的服务器收到请求后，如果自己无法解析，它就会找一个管理.com域的下一级DNS服务器地址([http://qq.com](http://qq.com/))给本地DNS服务器。当本地DNS服务器收到这个地址后，就会找（[http://qq.com](http://qq.com/))域服务器，重复上面的动作，进行查询，直至找到www.qq.com主机。
...
![image-20220415004400166](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430702.png)
...
![image-20220514172130459](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430529.png)
...
![image-20220514172435398](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430124.png)
...
![image-20220415010105484](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430455.png)
...
![image-20220415010205891](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430761.png)
...
![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430424.png)
...
![image-20220514172833216](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430459.png)
...
![img](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430613.png)
...
- 为了表示URL，[java.net](http://java.net/) 中实现了类 URL。我们可以通过下面的构造器来初始化一个 URL 对象：
...
![image-20220415013546074](https://raw.githubusercontent.com/Jenlybein/My-Typora-Images/imgs/202409230430621.png)
...
- Java 中有关网络方面的功能都定义在 [java.net](http://java.net/) 程序包中。Java 用 InetAddress 对象表示 IP 地址，该对象里有两个字段：主机名(String) 和 IP 地址(int)。
